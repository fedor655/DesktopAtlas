...
Раскладка по смыслу — это LaBSE, UMAP, кэш эмбеддингов, сторож раз в четыре секунды
и десять минут первого прогона. Сортировка по алфавиту в обычной папке проводника
даёт почти тот же эффект: одинаковые темы часто начинаются на одну букву — и ни одного
фонового процесса. Не говорите автору.
