...
DRIFT_TRIGGER = 6
# Пауза между возвратами. Раньше стояло двадцать секунд — на прежнем алгоритме
# перестановка шла долго и волнами, и без паузы сторож дрался с проводником.
# Теперь весь план считается заранее и применяется меньше чем за секунду,
# так что можно реагировать почти сразу.
COOLDOWN_SECONDS = 5
